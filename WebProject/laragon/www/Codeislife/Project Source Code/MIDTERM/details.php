...
<form method="get"> 
    <div class="row">
        ...
        <div class="col-md-8 col-sm-7">
           <?php echo '<h3>'. $arrayShirt[$pk]['name'] . '  <span class="badge badge-secondary">₱'.$arrayShirt[$pk ]['price'] .'</h3>'; 
                ?>
                ...
                if (isset($size)) {
                    foreach ($size as $key) {
                        echo '<input type="radio" name="rd" id="rd'.$key.'" value="">';
                        echo '<label for="rd'.$key.'">'.$key.' &nbsp&nbsp</label>';
                    }        
                }
